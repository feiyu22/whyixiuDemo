...
<!--                             </div> -->
                        ...
                        <table class="table table-bordered table-hover table-striped dataTables-example">
                            <thead>
                                <tr>
                                    ...
                                    <th class="col-sm-6 text-center">条形码</th>
                            ...
                            <tbody>
	                           <c:forEach items="${list }" var="sto" varStatus="sta">
	                           	 <tr class="gradeA">
	                                   ...
	                                   <td class="center"> 
		                                   <a class="btn btn-warning btn-xs tab_del" href="/stock/detail?code=${sto.code}">查看详细</a>
	                                   </td>
	                               </tr>
	                           </c:forEach>
                            </tbody>
						...
						<div class="row">
							<div class="col-sm-1">
								<a href="#"><button type="button" class="btn glyphicon glyphicon-file" id="exp">导出</button></a>
							</div>
						</div>
					</div>
                </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            $("#exp").click(function(){
				$("#search_form").attr('action','/stock/exp');
				$("#search_form").attr('target','_blank');
				$("#search_form").submit();
				$("#search_form").attr('action','/stock/list');
